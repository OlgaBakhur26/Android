  ...
  public List<Contact> getAll() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new Contact(_tmpPersonName,_tmpContactType,_tmpContactDetails,_tmpId);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  public Contact getById(final String id) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        final String _tmpId;
        _tmpId = _cursor.getString(_cursorIndexOfId);
        _result = new Contact(_tmpPersonName,_tmpContactType,_tmpContactDetails,_tmpId);
      } else {
        _result = null;
      }
      return _result;
