  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `CONTACT_TABLE` (`personName` TEXT, `contactType` TEXT, `contactDetails` TEXT, `id` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE INDEX IF NOT EXISTS `index_CONTACT_TABLE_id` ON `CONTACT_TABLE` (`id`)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2cbbd4572459d3313fa7227e381dcf2b')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsCONTACTTABLE.put("personName", new TableInfo.Column("personName", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCONTACTTABLE.put("contactType", new TableInfo.Column("contactType", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCONTACTTABLE.put("contactDetails", new TableInfo.Column("contactDetails", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoCONTACTTABLE.equals(_existingCONTACTTABLE)) {
          return new RoomOpenHelper.ValidationResult(false, "CONTACT_TABLE(com.example.multithreading.database.Contact).\n"
                  + " Expected:\n" + _infoCONTACTTABLE + "\n"
                  + " Found:\n" + _existingCONTACTTABLE);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "2cbbd4572459d3313fa7227e381dcf2b", "f3fa0146f06bd4acdf76f7878466d8ed");
