...
class RandomDishRepositoryImpl(
    private val okHttpClient: OkHttpClient,
    private val randomDishDataModelMapper: (String) -> RandomDishDataModel
) : RandomDishRepository {

    override fun getRandomDish(): Single<RandomDishDataModel> {
        ...
        return Single.create<String> { emitter ->
            ...
            .map { jsonData -> randomDishDataModelMapper(jsonData) }
    }
}
